        ...
        <div className="bg-cover bg-accent-dark">
            ...
            <main>
                ...
                <div className="h-screen bg-slate-100 dark:bg-slate-900 scroll-smooth overflow-auto" >
                        <div className="flex flex-grow justify-between mt-10 h-screen space-x-10">
                            <div className="flex-auto w-40 pl-28 pt-28"> 
                               <Image src={ProfilePic} width={320} height={380} className="rounded-full overflow-hidden" />
                            </div>
                            <div className="flex-auto w-96 mt-20 dark:text-indigo-200 text-zinc-600 space-y-2 pr-20">
                                <p className="dark:text-indigo-200 text-2xl font-light">
                                    Hello, I am Alfredo Baldoceda
                                </p>

                                <p className="text-zinc-900 dark:text-white text-xl font-thin py-2 pr-20 text-justify">
                                    Originally from Peru, I received my bachellor degree on Systems engineering.<br/>
